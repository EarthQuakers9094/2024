...
// Rotation3d reading = new Rotation3d(new Quaternion(wxyz[0], wxyz[1], wxyz[2],
// wxyz[3]));
...
// return Optional.of(new Translation3d(initial[0], initial[1],
// initial[2]).times(9.81 / 16384.0));
// }
