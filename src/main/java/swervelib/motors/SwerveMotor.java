...
public abstract class SwerveMotor
{
  ...
  @AutoLog
  public class SwerveMotorInput {
      public final double velocity = 0.0;
      public final double position = 0.0;
  }


  public SwerveMotorInputAutoLogged inputs;

  private final int moduleNumber;

  public final void updateInputs() {
    inputs.velocity = this.getVelocityInternal();
    inputs.position = this.getPositionInternal();
    ...
    Logger.processInputs("SwerveModule/motor" + type + Integer.toString(moduleNumber), inputs);
  }

  public SwerveMotor(int module) {
    moduleNumber = module,
  }
   ...
   */
  public default void factoryDefaults() {}
   ...
   */
  public default SwerveMotor setAbsoluteEncoder(SwerveAbsoluteEncoder encoder) {}
   ...
   */
  public default void configureIntegratedEncoder(double positionConversionFactor) {}
   ...
   */
  public default void configurePIDF(PIDFConfig config) {}
   ...
   */
  public default void configurePIDWrapping(double minInput, double maxInput) {}
   ...
   */
  public default void setMotorBrake(boolean isBrakeMode) {}
   ...
   */
  public default void setReference(double setpoint, double feedforward) {}
   ...
   */
  public default void setReference(double setpoint, double feedforward, double position) {}
   ...
   */
  public default double getPositionInternal() {
      return 0.0;
  }
   ...
   */
  public default void setVoltageCompensation(double nominalVoltage) {}
   ...
   */
  public default void setLoopRampRate(double rampRate) {}
   ...
   * @return Motor object.
   */
  public default Object getMotor() {
      return ();
  }
   ...
   */
  public default boolean isAttachedAbsoluteEncoder() {}
}
