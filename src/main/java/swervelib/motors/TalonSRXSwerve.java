...
// */
// private final TalonSRXConfiguration configuration = new
...
// WPI_TalonSRX motor;
// /**
// * The position conversion factor to convert raw sensor units to Meters Per
// 100ms, or Ticks to Degrees.
// */
...
// *
// * @param positionConversionFactor The conversion factor to apply for
// position.
// * <p><br>
// * Degrees: <br>
// * <code>
...
// * @param CANStatus21 Integrated Sensor Position (Talon FX), Integrated Sensor
// Velocity (Talon FX)
// * @param CANStatusCurrent Brushless Supply Current Measurement, Brushless
// Stator Current Measurement
// */
// public void configureCANStatusFrames(int CANStatus1, int CANStatus2, int
// CANStatus3, int CANStatus4, int CANStatus8,
...
// * @return Setpoint as native sensor units. Encoder ticks per 100ms, or
// Encoder tick.
// */
...
// SwerveMath.placeInAppropriate0To360Scope(position, setpoint);
...
// */
// @Override
// public void setReference(double setpoint, double feedforward, double
// position)
// {
