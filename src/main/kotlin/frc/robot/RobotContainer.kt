...
class RobotContainer {
        ...
        init {
                ...
                if (!onTest.config) {
                        ...
                        NamedCommands.registerCommand(
                                        "pickup",
                                        Pickup(shooter!!, elevator!!, intake!!).build()
                        )
                        NamedCommands.registerCommand(
                                        "faceSpeaker",
                                        FaceDirection(
                                                        swerveDrive,
                                                        { swerveDrive.speakerAngle() },
                                                        false
                                        )
                        )
                        NamedCommands.registerCommand(
        ...
        private fun configureBindings() {
                ...
                if (shooter != null && intake != null && elevator != null) {
                        ...
                        JoystickButton(operatorExtra, 9)
                                        .onTrue(SetValue.setHeight(elevator!!, true, 47.0))
                        JoystickButton(operatorExtra, 10)
                                        .onTrue(SetValue.setHeight(elevator!!, true, 0.0))
